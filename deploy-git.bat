...
ssh -p %SERVER_PORT% %SERVER_USER%@%SERVER_IP% "cd /d %PARENT_DIR%\%PROJECT_DIR% && %REMOTE_GIT% pull origin %BRANCH% && (php migrasi.php 2>nul || C:\laragon\bin\php\php-8.5.6-nts-Win32-vs17-x64\php.exe migrasi.php || C:\laragon\bin\php\php-8.1.10-Win32-vs16-x64\php.exe migrasi.php)"
