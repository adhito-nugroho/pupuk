...
<div class="doc-card p-6 mb-5 fade-in">
  <div class="flex flex-wrap items-start justify-between gap-4 pb-5 border-b border-kadaster-border">
    ...
    <div class="flex flex-wrap items-center gap-2">
      ...
      <a href="laporan.php?kth_id=<?= $kthId ?>&v=<?= $versiAktif ?>" class="btn-forest px-4 py-2 text-xs inline-flex items-center gap-1.5 font-semibold">
...
<div class="doc-card p-5 mb-5 fade-in">
  <div class="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-kadaster-border mb-3">
    ...
    <div class="flex items-center gap-4 text-xs">
      ...
      <a href="cetak_peta.php?kth_id=<?= $kthId ?>&v=<?= $versiAktif ?>" target="_blank" class="btn-kadaster px-3 py-1.5 text-xs inline-flex items-center gap-1 font-medium">
...
(function () {
  ...
  fetch(`peta_data.php?kth_id=${KTHID}&v=${VERSI}`)
    .then(r => r.json())
    .then(data => {
      const bounds = [];
